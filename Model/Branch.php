 ...
 */
	public $hasMany = array(
		...
		'Organizationfunction' => array(
			'className' => 'Organizationfunction',
			'foreignKey' => 'branch_id',
			'dependent' => false,
			'conditions' => '',
			'fields' => '',
        ...
        public function BranchesList($orgId = null) {
         ...
         public function orgBranchList($orgId = null) {
            $this->recursive = -1;
            $branchlist = $this->find('all', array('conditions'=>array('Branch.organization_id'=>$orgId)));
            return $branchlist;
        }  
