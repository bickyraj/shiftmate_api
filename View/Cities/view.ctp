...
<h2><?php echo __('City'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo $this->Html->link($city['Country']['title'], array('controller' => 'countries', 'action' => 'view', $city['Country']['id'])); ?>
			&nbsp;
		</dd>
...
<div class="related">
	...
	<?php if (!empty($city['Organization'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
		<th><?php echo __('User Id'); ?></th>
	...
	<?php foreach ($city['Organization'] as $organization): ?>
		<tr>
