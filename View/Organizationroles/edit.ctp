...
<?php echo $this->Form->create('Organizationrole'); ?>
	<fieldset>
		<legend><?php echo __('Edit Organizationrole'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Organizationrole.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Organizationrole.id'))); ?></li>
