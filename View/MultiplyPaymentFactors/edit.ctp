...
<?php echo $this->Form->create('MultiplyPaymentFactor'); ?>
	<fieldset>
		<legend><?php echo __('Edit Multiply Payment Factor'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MultiplyPaymentFactor.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('MultiplyPaymentFactor.id'))); ?></li>
