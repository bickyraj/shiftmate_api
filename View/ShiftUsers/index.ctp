<div class="shiftUsers index">
	<h2><?php echo __('Shift Users'); ?></h2>
	...
	<tr>
		<td><?php echo h($shiftUser['ShiftUser']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($shiftUser['ShiftUser']['date']); ?>&nbsp;</td>
		<td><?php echo h($shiftUser['ShiftUser']['status']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $shiftUser['ShiftUser']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $shiftUser['ShiftUser']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $shiftUser['ShiftUser']['id']), null, __('Are you sure you want to delete # %s?', $shiftUser['ShiftUser']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
