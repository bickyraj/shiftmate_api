 ...
 */
	protected function _resizePhp(Model $model, $field, $path, $size, $geometry, $thumbnailPath) {
		...
		if ($src) {
			...
			if(isset($this->runtime[$model->alias][$field]['x'])&& !empty($this->runtime[$model->alias][$field]['x']))
			{
				
				$x = $this->runtime[$model->alias][$field]['x'];
				$y = $this->runtime[$model->alias][$field]['y'];
				$srcH = $this->runtime[$model->alias][$field]['srcH'];
				$srcW = $this->runtime[$model->alias][$field]['srcW'];
			}
